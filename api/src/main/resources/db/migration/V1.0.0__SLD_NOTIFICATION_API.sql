...
(
    TABLESPACE API_SLD_NOTIF_BLOB_DATA
);

CREATE INDEX SLD_NOTIFICATION_EVENT_EVENT_STATUS_IDX ON SLD_NOTIFICATION_EVENT (EVENT_STATUS) TABLESPACE API_SLD_NOTIF_IDX;
CREATE INDEX SLD_NOTIFICATION_EVENT_EVENT_TYPE_IDX ON SLD_NOTIFICATION_EVENT (EVENT_TYPE) TABLESPACE API_SLD_NOTIF_IDX;
